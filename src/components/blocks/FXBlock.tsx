            ...
            {params.shocks.map((shock, index) => (
              <div key={index} className="flex items-center gap-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
                <div className="flex-1">
                  ...
                  <input
                    title="Currency Pair"
                    aria-label="Currency pair for shock"
                    type="text"
                ...
                <div className="flex-1">
                  ...
                  <input
                    title="Shock Percentage"
                    aria-label="Shock percentage for currency pair"
                    type="number"
                    step="0.1"
                ...
                <button
                  title="Remove FX shock"
                  aria-label="Remove FX shock"
