          ...
          <div key={model.id} className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                ...
                <input
                  ...
                  aria-label="Beta coefficient for NMD model"
                  type="number"
                  step="0.01"
                  value={model.beta ?? 0}
                  onChange={(e) => {
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    title="Volatile percentage"
                    aria-label="Volatile percentage for NMD model"
                    type="number"
                    step="0.1"
            ...
            <div className="border border-slate-200 rounded-lg overflow-hidden">
              <div className="bg-slate-50 px-4 py-2 border-b border-slate-200 flex justify-between items-center">
                ...
                <button
                  title="Add row to matrix"
                  aria-label="Add row to matrix"
                    ...
                    <tr key={rIdx}>
                      ...
                      <td className="px-4 py-2">
                        <input
                          ...
                          aria-label="Deposit stable percentage"
                          type="number"
              ...
              {model.type === 'CPR' && (
                <div>
                  ...
                  <input
                    ...
                    aria-label="Prepayment speed multiplier"
                    type="number"
                    step="0.1"
