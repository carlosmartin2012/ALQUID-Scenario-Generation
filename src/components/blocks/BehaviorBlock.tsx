                    ...
                    <div key={model.id} className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input
                                    title="NMD Beta"
                                    aria-label="Behavioral Beta for NMD"
                                    type="number"
                                    step="0.01"
                                    value={model.beta ?? 0}
                                    onChange={(e) => {
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        title="Volatile Pct"
                                        aria-label="Volatile portion percentage"
                                        type="number"
                                        step="0.1"
                        ...
                        <div className="border border-slate-200 rounded-lg overflow-hidden">
                            <div className="bg-slate-50 px-4 py-2 border-b border-slate-200 flex justify-between items-center">
                                ...
                                <button
                                    ...
                                    aria-label="Add new row to semistable matrix"
                                    ...
                                    {model.semistable_matrix.map((row, rIdx) => (
                                        <tr key={rIdx}>
                                            ...
                                            <td className="px-4 py-2 text-center">
                                                <button
                                                    title="Remove Matrix Entry"
                                                    aria-label="Remove this row from semistable matrix"
